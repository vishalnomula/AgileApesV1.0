...
import com.example.agileapes.LocationRecyclerViewAdapter;
import com.example.agileapes.IndividualLocation;
import com.example.agileapes.LinearLayoutManagerWithSmoothScroller;
...
public class MapActivity extends AppCompatActivity implements
    ...
    private static final LatLngBounds LOCKED_MAP_CAMERA_BOUNDS = new LatLngBounds.Builder()
            ...
            .include(new LatLng(-33.891,
                    151.3279)).build();
    private static final LatLng MOCK_DEVICE_LOCATION_LAT_LNG = new LatLng(-34, 151);
